...
train_PFfeatures = train_PFfeatures(1:round(length(train_features)*1),:);
% 
...
tic;
model = LUPAPI(train_labels, K, tK, svmplus_param.svm_C, svmplus_param.svm_C_star,svmplus_param.gamma,l);
t_l2 = toc;
...
fprintf("\n================\n")
fprintf(2, 'L2-LUPAPI, time=%f, Accuracy = %.4f.\n', t_l2, acc_l2);
fprintf(2, 'L2-LUPAPI, Sensitivity=%.2f. Specificty = %.2f.\n', sens_l2, spec_l2);
fprintf(1, 'L2-LUPAPI, AUC score = %.2f', AUC_l2);
fprintf("\n================\n")

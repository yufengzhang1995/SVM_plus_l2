...
train_PFfeatures = train_PFfeatures(1:round(length(train_features)*0.92),:);
% 
l = length(train_PFfeatures);
...
tic;
model = LULUPAPI(train_labels, K, tK, svmplus_param.svm_C, svmplus_param.svm_C_star,svmplus_param.gamma,weight,l);
t_l2 = toc;
...
fprintf("\n================\n")
fprintf(2, 'L2-LULUPAPI, time=%f, Accuracy = %.4f.\n', t_l2, acc_l2);
fprintf(2, 'L2-LULUPAPI, Sensitivity=%.2f. Specificty = %.2f.\n', sens_l2, spec_l2);
fprintf(1, 'L2-LULUPAPI, AUC score = %.2f', AUC_l2);
fprintf("\n================\n")
